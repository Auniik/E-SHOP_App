        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{URL::to($v_manufacture_product->product_image)}}" style="height: 250px" alt="" />
                    <h2>{{$v_manufacture_product->product_price}} TK</h2>
                    <p>{{$v_manufacture_product->product_name}}</p>
                    <a href="{{URL::to('/view-product/'.$v_manufacture_product->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
            ...
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="{{URL::to('/view-product/'.$v_manufacture_product->product_id)}}"><i class="fa fa-plus-square"></i>View Product</a></li>
                </ul>
            </div>
        </div>
    </div>
